...
# Recommended to run in a separate session of RStudio from the main script, as this script uses many of the same object names.
...
library(grid)
library(gridExtra)
library(runjags) #contains the jags summary function

# Load model output generated from the main script
...
# Save or load the model summary on your computer
#save(PriorCheck.ModelSummary,file="PriorPredCheck/PriorCheck.ModelSummary.RData")  #SAVE
load("PriorPredCheck/PriorCheck.ModelSummary.RData")  #LOAD
