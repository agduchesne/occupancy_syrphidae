...
# Requires running the Prior Predictive Check model from the main script. See syrphid_occupancy_main.R
# Please set working directory to syrphid_occupancy folder


# Load Prior Predictive Check Model Output and species list
